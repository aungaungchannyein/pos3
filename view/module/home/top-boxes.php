...
$sales = SaleController::ctrAddingTotalSales();

$categories = CategoryController::ctrShowCategory($item, $value);
$totalCategories = count($categories);

$customers = ClientController::ctrShowClient($item, $value);
$totalCustomers = count($customers);

$products = ProductController::ctrShowProduct($item, $value, $order);
