...
$products = ProductController::ctrShowProductorder($item, $value, $order);
			 ...
			 <?php
          	...
          	for($i = 0; $i <5; $i++){
          		...
          		echo '<li>
						 ...
						 <img src="'.$products[$i]["photo"].'" class="img-thumbnail" width="60px" style="margin-right:10px"> 
						 '.$products[$i]["description"].'

						 <span class="pull-right text-'.$colours[$i].'">   
						 '.ceil($products[$i]["sold_quantity"]*100/$salesTotal["total"]).'%
						 </span>
...
<script>
  ...
  for($i = 0; $i < 10; $i++){
  	...
  	echo "{
      value    : ".$products[$i]["sold_quantity"].",
      color    : '".$colours[$i]."',
      highlight: '".$colours[$i]."',
